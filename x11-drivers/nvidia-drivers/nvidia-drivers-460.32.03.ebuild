...
SRC_URI="
	amd64? ( https://us.download.nvidia.com/XFree86/Linux-x86_64/${PV}/${AMD64_NV_PACKAGE}.run )
	tools? (
...
IUSE="compat +driver gtk3 kernel_linux +kms +libglvnd multilib static-libs +tools uvm wayland +X"
REQUIRED_USE="
	tools? ( X )
	static-libs? ( tools )
"
